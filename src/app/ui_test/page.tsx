...
const categories: { name: Categories; label: string }[] = [
  { name: "RECOMMENDED", label: "おすすめ" },
  { name: "SET", label: "セット・定食" },
...
const UiTestPage = () => {
  const [selectedCategory, setSelectedCategory] =
    useState<Categories>("RECOMMENDED");
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    {menu.isRecommended && (
                                      <Badge
                                        variant="default"
                                        className="border-red-500 hover:bg-red-600 text-red-500  hover:text-white text-xs"
                                      >
                                        おすすめ
                                      </Badge>
                                    )}
